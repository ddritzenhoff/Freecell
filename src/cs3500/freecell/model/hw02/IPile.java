...
/**
 * This interface represents different operations that an IPile model must support to return
...
public interface IPile<ICard> {
   ...
   * @throws IllegalArgumentException when there are no cards to get from the pile (i.e. the pile
   * is empty).
   */
