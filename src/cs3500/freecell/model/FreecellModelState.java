...
public interface FreecellModelState<K> {
     ...
     * @throws IllegalStateException if the game has not started
     */
    K getFoundationCardAt(int pileIndex,int cardIndex) throws IllegalArgumentException,IllegalStateException;
     ...
     * @throws IllegalStateException if the game has not started
     */
    K getCascadeCardAt(int pileIndex,int cardIndex)  throws IllegalArgumentException,IllegalStateException;
